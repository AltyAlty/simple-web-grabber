/*
Библиотека Playwright - это библиотека для автоматизации браузеров, разработанная компанией Microsoft. Она предназначена
для создания тестов и автоматизации взаимодействия с веб-приложениями.
...
/*Импортируем объект, с методами и данными для получения данных.*/
